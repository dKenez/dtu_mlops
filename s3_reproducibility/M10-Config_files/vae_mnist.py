...
def main(cfg):
    ...
    # save weights
    torch.save(model, f"{os.getcwd()}/{cfg.paths.checkpoint}.pt")
    ...
    save_image(x.view(batch_size, 1, 28, 28), f'{cfg.paths.orig_data}.png')
    save_image(x_hat.view(batch_size, 1, 28, 28), f'{cfg.paths.reconstructions}.png')
    ...
    save_image(generated_images.view(batch_size, 1, 28, 28), f'{cfg.paths.generated_sample}.png')
